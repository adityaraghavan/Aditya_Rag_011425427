...
If the value if less than their own value the incoming message is swallowed.
If the value is greater than their own value then this message is forwarded to the neighbour on the left.
